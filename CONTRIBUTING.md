Contributing to Shitcoin Core V1.0.0
============================
...
your decisions. Further explanation.
...
The following applies to code changes to the Shitcoin Core project, and is not to be
confused with overall Shitcoin Network Protocol consensus changes.

Whether a pull request is merged into Shitcoin Core rests with the project merge
...
Patches that change Shitcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Shitcoin consensus, it must have been
...
The project leader is the release manager for each Shitcoin Core release.
