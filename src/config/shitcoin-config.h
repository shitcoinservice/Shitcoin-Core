...
#ifndef Shitcoin_CONFIG_H

#define Shitcoin_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.shitcoin.cash"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Shitcoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Shitcoin Core 1.0.0"
