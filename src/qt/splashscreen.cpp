...
SplashScreen::SplashScreen(Qt::WindowFlags f, const NetworkStyle* networkStyle) : QWidget(0, f), curAlignment(0)
{
    ...
    int titleCopyrightVSpace = 38;

    float fontFactor = 1.0;

    // define text to place
    QString titleText = tr("Shitcoin Core");
    ...
    QString copyrightTextShitcoin = QChar(0xA9) + QString(" 2017-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The Shitcoin Core developers"));
    ...
    pixPaint.drawText(paddingLeft, paddingTop + titleCopyrightVSpace + 36, copyrightTextShitcoin);
