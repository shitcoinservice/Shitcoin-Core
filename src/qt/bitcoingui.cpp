                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Shitcoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Shitcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Shitcoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Shitcoin"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Shitcoin Core help message to get a list with possible Shitcoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Shitcoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Shitcoin network", "", count));
}
...
{
    QString strTitle = tr("Shitcoin Core"); // default title
...
/** Creates context menu, its actions, and shitcoins up all the relevant signals for mouse events. */
