                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received SHC from zSHC"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zSHC"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zSHC));
