...
Object blockToJSON(const CBlock& block, const CBlockIndex* blockindex, bool txDetails = false)
{
    ...
    for (auto denom : libzerocoin::zerocoinDenomList) {
        zshitcoinObj.push_back(Pair(to_string(denom), ValueFromAmount(blockindex->mapZerocoinSupply.at(denom) * (denom*COIN))));
    }
    zshitcoinObj.emplace_back(Pair("total", ValueFromAmount(blockindex->GetZerocoinSupply())));
    result.emplace_back(Pair("zShitcoinsupply", zshitcoinObj));
...
Value getrawmempool(const Array& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "    \"fee\" : n,              (numeric) transaction fee in shitcoin\n"
...
Value getblock(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "  \"zShitcoinsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zShitcoin denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zShitcoin denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zShitcoin denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zShitcoin denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zShitcoin denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zShitcoin denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zShitcoin denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zShitcoin denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zShitcoin denominations\n"
            "  }\n"
            "}\n"
            "\nResult (for verbose=false):\n"
...
Value gettxout(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 3)
        throw runtime_error(
            ...
            "     \"shitcoinaddress\"   	 	(string) shitcoin address\n"
            "        ,...\n"
            "     ]\n"
            "  },\n"
