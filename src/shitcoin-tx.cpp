...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Shitcoin Core shitcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  shitcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded shitcoin transaction") + "\n" +
                               "  shitcoin-tx [options] -create [commands]   " + _("Create hex-encoded shitcoin transaction") + "\n" +
                               "\n";
