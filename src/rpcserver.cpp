...
CAmount AmountFromValue(const Value& value)
{
    ...
    if (dAmount <= 0.0 || dAmount > 8000000.0)
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Shitcoin features */
        {"shitcoin", "masternode", &masternode, true, true, false},
        {"shitcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"shitcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"shitcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"shitcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"shitcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"shitcoin", "startmasternode", &startmasternode, true, true, false},
        {"shitcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"shitcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"shitcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"shitcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"shitcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"shitcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"shitcoin", "mnbudget", &mnbudget, true, true, false},
        {"shitcoin", "preparebudget", &preparebudget, true, true, false},
        {"shitcoin", "submitbudget", &submitbudget, true, true, false},
        {"shitcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"shitcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"shitcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"shitcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"shitcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"shitcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"shitcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"shitcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"shitcoin", "mnsync", &mnsync, true, true, false},
        {"shitcoin", "spork", &spork, true, true, false},
        {"shitcoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        /* Wallet */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use shitcoind, or the -server option to shitcoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:2333/\n";
}
