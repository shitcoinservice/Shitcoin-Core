...
AC_DEFUN([BITCOIN_QT_INIT],[
  ...
  AC_ARG_WITH([gui],
    ...
    [build shitcoin-qt GUI (default=auto, qt5 tried first)])],
    [
...
AC_DEFUN([_BITCOIN_QT_IS_STATIC],[
  ...
  if test shitcointcoin_cv_static_qt = xyes; then
...
AC_DEFUN([_BITCOIN_QT_FIND_LIBS_WITHOUT_PKGCONFIG],[
  ...
  BITCOIN_QT_CHECK(AC_CHECK_LIB([${QT_LIB_PREFIX}Network],[main],,BITCOIN_QT_FAIL(lib$QT_LIB_PREFIShitcoinetwork not found)))
  if test x$bitcoin_qt_got_major_vers = x5; then
