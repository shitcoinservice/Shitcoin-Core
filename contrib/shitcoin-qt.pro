...
RESOURCES += src/qt/shitcoin.qrc src/qt/shitcoin_locale.qrc

TRANSLATIONS += src/qt/locale/shitcoin_bg.ts \
                src/qt/locale/shitcoin_de.ts \
                src/qt/locale/shitcoin_en.ts \
                src/qt/locale/shitcoin_es.ts \
                src/qt/locale/shitcoin_fi.ts \
                src/qt/locale/shitcoin_fr.ts \
                src/qt/locale/shitcoin_it.ts \
                src/qt/locale/shitcoin_ja.ts \
                src/qt/locale/shitcoin_pl.ts \
                src/qt/locale/shitcoin_pt.ts \
                src/qt/locale/shitcoin_ru.ts \
                src/qt/locale/shitcoin_sk.ts \
                src/qt/locale/shitcoin_sv.ts \
                src/qt/locale/shitcoin_vi.ts \
                src/qt/locale/shitcoin_zh_CN.ts \
                src/qt/locale/shitcoin_zh_TW.ts
